...
import random
import scipy.io
from prepare.collision_check import collision_free, get_bounding_box, contact_points, collision_response
...
interval = (t1 - t0)
save_video = False
num_frames = 20 # number of the first frames to save in video
